...
function wf_d_rate_factor_callback() {
    ...
    <p><?php echo esc_html__('Add the value of the KW Powerplant Size D Rate Factor (Bill Entry Method)', 'wf_image_api'); ?></p>
    <?php
...
add_settings_field(
            ...
            'wf_kwh_tf_year_callback', //Field Callback //TODO Possible Change Request NOT NEEDED(?)
            'wf_calculations_register_settings_section', //do_settings_sections
            'wf_solar_calc' //page_name
        );
register_setting(
            'wf_solar_calculations_page', //settings_fields
            'wf_solar_kwh_tf_year'  //get_option name //TODO Possible Change Request NOT NEEDED(?)
        );
...
function wf_roof_shade_south_east_production_ratio_kwh_callback() {
    ?>
    <input type="number" step="any" class="roof_shade_south_east_production_ratio_kwh" name="wf_solar_roof_shade_south_east_production_ratio_kwh" value="<?php echo esc_attr(get_option('wf_solar_roof_shade_south_east_production_ratio_kwh') ); ?>" ><span><b> % </b></span>
    <p><?php echo esc_html__('Used in Annual Production Calculation for HW Entry Method (Annual Production = System Size x 1000 x Production Ratio)', 'wf_image_api'); ?></p>
    <?php
...
register_setting(
            'wf_solar_calculations_page', //settings_fields
            'wf_solar_roof_shade_east_production_ratio_kwh'  //get_option name //TODO Possible Change Request DONE
        );
...
register_setting(
            'wf_solar_calculations_page', //settings_fields
            'wf_solar_roof_shade_south_west_production_ratio_kwh'  //get_option name //TODO Possible Change Request DONE
        );
...
register_setting(
            'wf_solar_calculations_page', //settings_fields
            'wf_solar_roof_shade_west_production_ratio_kwh'  //get_option name //TODO Possible Change Request DONE
        );
